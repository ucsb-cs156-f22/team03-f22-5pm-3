...
public class ArticleControllerTests extends ControllerTestCase {
    ...
    public void admin_can_edit_an_existing_article() throws Exception {
        ...
        Article articleOrig = Article.builder()
                ...
                .email("josiahnross@ucsb.edu")
                .explanation("Test explaination")
                .dateAdded(dateAddedOrig)
                .build();

        LocalDateTime dateAddedEdit = LocalDateTime.parse("2022-03-11T00:00:00");

        Article articleEdit = Article.builder()
                .title("Test article title Edit")
                .url("http://localhostEdit:8080/")
                .email("josiahnrossEdit@ucsb.edu")
                .explanation("Test explaination edit")
                .dateAdded(dateAddedEdit)
                .build();

        String requestBody = mapper.writeValueAsString(articleEdit);
        ...
        verify(articleRepository, times(1)).save(articleEdit); // should be saved with correct user
        String responseString = response.getResponse().getContentAsString();
